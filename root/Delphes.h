...
// Mon Mar 22 18:15:48 2021 by ROOT version 6.18/02
// from TTree Delphes/Analysis tree
// found on file: RPV_1400-1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("RPV_1400-1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("RPV_1400-1.root");
      }
