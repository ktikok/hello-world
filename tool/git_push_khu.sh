  ...
  do
    for i in `echo "sgd adam radam ranger"`
      do
        ...
        rm -r ~/work/HEP-CNN-results/training/224x224_track"$k"/model_"$j"/run__lr_1e-3__batch_64__optimizer_"$i"/
        ...
        gzip ~/work/HEP-CNN-results/training/224x224_track"$k"/model_"$j"/run__lr_1e-3__batch_64__optimizer_"$i"/*
