...
void ConfidenceIntervals()
{
   ...
   TCanvas *myc = new TCanvas("myc",
  "Confidence intervals on the fitted function",500, 500);//size of window(title, width, height)
   
   //myc->Divide(3,1);
   myc->Divide(1,1);//picture location(howmany, where)
       cout<<"start1"<<endl;
